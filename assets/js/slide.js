...
(function () {
  ...
  function createPagination(self) {
    ...
    // Chamada do plugin de carousel
    new ElderCarousel(
        '.carousel-multiple-items', { // Nome da classe css que ira invocar o carousel
        items: 6, // Quantidade de itens na tela
        step: 1, // Quantidade de 'passos'/itens que ira pular por vez
        play: true, // Se vai iniciar sozinho ou nao
        playInterval: 8000 // Intervalo em milesegundos (Acho que escrevi errado)
    })
